...
export class Backend implements backendInterface {
    ...
    async getAllData(): Promise<Array<Data>> {
        if (this.processError) {
            try {
    ...
    async getCallerData(): Promise<Array<Data>> {
        if (this.processError) {
            try {
    ...
    async getData(arg0: string): Promise<Data | null> {
        if (this.processError) {
            try {
    ...
    async uploadData(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadData(arg0, await to_candid_ExternalBlob_n25(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Data_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Data): Promise<Data> {
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Data]): Promise<Data | null> {
    return value.length === 0 ? null : await from_candid_Data_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Data>): Promise<Array<Data>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Data_n11(_uploadFile, _downloadFile, x)));
}
